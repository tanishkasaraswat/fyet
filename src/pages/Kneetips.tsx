// KneetipsThreePage.tsx
import { Helmet } from "react-helmet";
import { Text, Heading } from "../components";
import { Header1, Footer1 } from "../components";
import React from "react";

export default function KneetipsPage() {
  return (
    <>
      <Helmet>
              <title>fyet</title>
        ...
        <div className="mx-[74px] rounded-[50px] bg-fyet_framer_website-white px-[54px] py-[104px] md:mx-0 md:p-5">
          ...
          >
            Large quantities of Alcohol intake can interfere with pain-relief drugs and other medications you may be taking for your knees.
          </Text>
        </div>
        </div>
        <Footer1 className="mt-[274px]" />
      </div>
    </>
  );
}