...
export default function NecktipsFourPage() {
  return (
    <>
      <Helmet>
        <title>fyet</title>
      ...
      <div className="mx-[74px] flex justify-center rounded-[50px] bg-fyet_framer_website-white py-[140px] md:mx-0 md:py-5">
        <div className="container-xs mb-1 flex justify-center px-11 md:px-5">
          ...
          >
            Ginger helps in relieving arthritis, nausea, headaches, muscle soreness, menstrual cramps, muscle pains, swollen veins, sprains, and backaches.
          </Text>
        </div>
      </div>
      </div>
