    ...
    <>
      ...
      <div className="w-full bg-fyet_framer_website-white">
        ...
        <div className="ml-[78px] mr-[70px] rounded-[50px] bg-fyet_framer_website-white px-[54px] py-[88px] md:mx-0 md:p-5">
          ...
          >
            Oregano makes its appearance as a calcium-rich herb. So, next time you order that large Italian pizza,
            freely sprinkle some oregano on top to boost your calcium intake.
          </Text>
        </div>
        <Footer1 />
      </div>
