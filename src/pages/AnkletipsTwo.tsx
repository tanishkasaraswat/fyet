...
export default function AnkletipsTwoPage() {
  return (
    <>
      <Helmet>
        <title>fyet</title>
      ...
      <div className="w-full bg-fyet_framer_website-white">
        <Header1 />
        <div className="flex flex-col gap-[220px] md:gap-[165px] sm:gap-[119px]">
      ...
      <div className="ml-[78px] mr-[70px] rounded-[50px] bg-fyet_framer_website-white px-[54px] py-[114px] md:mx-0 md:p-5">
        <Text
          as="p"
          className="mt-4 text-justify text-[48px] font-normal leading-[50px] tracking-[-0.50px] md:text-[44px] sm:text-[38px]"
        >
          Frankincense (GOOGOL) may also offer benefits for people with inflammation. the compounds in frankincense possess anti-inflammatory properties that could help relieve arthritis symptoms.
        </Text>
      </div>
      </div>
      <Footer1 />
