...
export default function KneetipsOnePage() {
  return (
    <>
      <Helmet>
        <title>fyet</title>
      ...
      <div className="w-full bg-fyet_framer_website-white">
        ...
        <div className="mx-[74px] rounded-[50px] bg-fyet_framer_website-white px-[54px] py-[138px] md:mx-0 md:p-5">
            ...
            >
                <span>
                Meat cooked at high temperatures are linked to diseases such as Arthritis, Heart Disease, and Diabetes. 
                you can reduce your levels of grilled, fried, broiled, and microwaved meats. it&#39;s also helpful
                to&nbsp;
                </span>
                <span className="font-bold">
                    <>
                        limit processed foods, as they are often cooked at high temperatures.
                        <br />
                    </>
                </span>
            </Text>
