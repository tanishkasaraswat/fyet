...
export default function KneetipsThreePage() {
    return (
      <>
        <Helmet>
          <title>fyet</title>
        ...
        <div className="w-full bg-fyet_framer_website-white">
          ...
          <div className="flex flex-col gap-[220px] md:gap-[165px] sm:gap-[110px]">
            <div className="flex h-[580px] flex-col items-center justify-center bg-[url(/public/images/tips-page.png)] bg-cover bg-no-repeat py-[166px] md:h-auto md:py-5">
          ...
          <div className="mx-[74px] rounded-[50px] bg-fyet_framer_website-white px-[54px] py-[102px] md:mx-0 md:py-5">
            ...
            >
              The Clove Oil or Powder is the best home remedy for pains. the clove gel is as effective as benzocaine
              gel(gel to relieve pain and itching).
            </Text>
          </div>
          <Footer1 />
        </div>
