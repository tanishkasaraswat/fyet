...
const data = [
  { userImage: "images/wrist-1.jpg", headingText: "Lifting", linkTo: "/Wristtips" },
  { userImage: "images/basil.jpg", headingText: "Basil", linkTo: "/WristtipsThree" },
  { userImage: "images/wrist-2.jpg", headingText: "Stretching", linkTo: "/WristtipsTwo" },
  { userImage: "images/aloevera.jpg", headingText: "Aloe vera", linkTo: "/WristtipsFour" },
  { userImage: "images/pineapple.jpg", headingText: "Pineapple", linkTo: "/WristtipsOne" },
];

export default function Wristtips1Page() {
  return (
    <>
      <Helmet>
        <title>fyet</title>
              ...
              <Suspense fallback={<div>Loading feed...</div>}>
                {data.map((d, index) => (
                  <Link
                    ...
                    <UserProfile2 {...d} key={"wristtips" + index} />
                    </Link>
                  ))}
                </Suspense>
            </div>
