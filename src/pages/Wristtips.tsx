...
export default function WristtipsPage() {
  return (
    <>
      <Helmet>
        <title>fyet</title>
      ...
      <div className="w-full bg-fyet_framer_website-white">
        ...
        <div className="container-xs mb-16 flex justify-center px-14 md:px-5">
          ...
          <div className="ml-[66px] mr-[82px] rounded-[50px] bg-fyet_framer_website-white px-[54px] py-[102px] md:mx-0 md:p-5">
            <Text
              as="p"
              className="w-full text-justify text-[48px] font-normal leading-[50px] tracking-[-0.50px] md:text-[44px] sm:text-[38px]"
            >
              Take care of your joints when you lift and carry, handbags on your arms instead of your hands that lets your bigger muscles and joints support the weight.
            </Text>
          </div>
        </div>
        <Footer1 />
