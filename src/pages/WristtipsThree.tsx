...
export default function WristitpsThreePage() {
  return (
    <>
      <Helmet>
        <title>fyet</title>
      ...
      <div className="w-full bg-fyet_framer_website-white">
        <Header1 />
        <div className="flex flex-col gap-[230px] md:gap-[165px] sm:gap-[110px]">
        ...
        <div className="ml-[78px] mr-[70px] rounded-[50px] bg-fyet_framer_website-white px-[54px] py-[138px] md:mx-0 md:p-5">
          ...
          >
            Basil is a powerhouse of minerals not just calcium but also magnesium. it provides by far the largest
            amount of calcium of any herb.
          </Text>
        </div>
      </div>
      <Footer1 />
