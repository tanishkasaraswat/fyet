...
export default function AnkletipsOnePage() {
  return (
    <>
      <Helmet>
        <title>fyet</title>
      ...
      <div className="w-full bg-fyet_framer_website-white">
        <Header1 />
        <div className="flex flex-col gap-[220px] md:gap-[172px] sm:gap-[119px]">
      ...
      <div className="mx-[74px] rounded-[50px] bg-fyet_framer_website-white px-[54px] py-[104px] md:mx-0 md:p-5">
        <Text 
          as="p"
          className="mt-3.5 text-justify text-[48px] font-normal leading-[50px] tracking-[-0.50px] md:text-[44px] sm:text-[38px]"
        >
          Ice is a natural pain reliever. It numbs the ache and eases swelling. If you have a sore joint, apply a cold pack or ice wrapped in a towel. leave it on for up to 20 minutes at a time. never put ice right on your skin.
        </Text>
      </div>
      </div>
      <Footer1 />
