...
export default function AnkletipsThreePage() {
  return (
    <>
      <Helmet>
        <title>fyet</title>
      ...
      <div className="ml-[78px] mr-[70px] rounded-[50px] bg-fyet_framer_website-white px-[54px] py-[88px] md:mx-0 md:p-5">
        ...
        >
          Make sure your shoes provide proper support for your feet and ankles. Avoid flip flops, sandals and shoes that are loose. It&#39;s especially important to wear proper footwear when playing sports because without the right footwear it can lead to ankle injuries.
        </Text>
      </div>
      </div>
      <Footer1 />
