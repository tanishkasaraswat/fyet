...
export default function AnkletipsFourPage() {
  return (
    <>
      <Helmet>
        <title>fyet</title>
      ...
      <div className="w-full bg-fyet_framer_website-white">
        ...
        <div className="ml-[78px] mr-[70px] rounded-[50px] bg-fyet_framer_website-white px-[54px] py-[164px] md:mx-0 md:p-5">
          <Text as="p" className="mt-4 text-justify text-[48px] font-normal leading-[50px] tracking-[-0.50px] md:text-[44px] sm:text-[38px]">
            Powerful antioxidant chemicals in Pomegranate fruit and juice help lower blood pressure.
          </Text>
        </div>
      </div>
        <Footer1 />
