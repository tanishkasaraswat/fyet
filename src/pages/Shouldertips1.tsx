...
export default function ShoulderTips1Page() {
  return (
    <>
      <Helmet>
        <title>fyet</title>
      ...
      <div className="w-full bg-fyet_framer_website-white">
        ...
        <div className="mx-[74px] flex justify-center rounded-[50px] bg-fyet_framer_website-white px-11 py-[102px] md:mx-0 md:py-5">
          <div className="container-xs mb-1 flex justify-center px-11 md:px-5">
            ...
            >
              Ashwagandha is a powerful herb. This herb is highly useful to decrease swelling as well as inflammation. 
