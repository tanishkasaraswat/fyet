    ...
    <>
      ...
      <div className="w-full bg-fyet_framer_website-white">
        ...
        <div className="ml-[78px] mr-[70px] rounded-[50px] bg-fyet_framer_website-white px-[54px] py-[88px] md:mx-0 md:p-5">
          ...
          >
            Vegetables like broccoli and cauliflower contain various antioxidants to ease systemic inflammation
            (redness, swelling and pain). They also act as a &quot;cleanse of sorts by filling your body with healthy
            fiber.
          </Text>
        </div>
        <Footer1 />
